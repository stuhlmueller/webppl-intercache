...
d<- fromJSON(readLines("all-data-window-10.json"))
...
Right: The average hit rate over a window of 10 calls, starting with a particular call.
...
Average query time over a window of 10 calls, compared to global average of non-cached query (avgSlowTime) and average time of cache hits (avgCacheLookupTime).
